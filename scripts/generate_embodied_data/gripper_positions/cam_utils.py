...
def calculate_2d_position(gripper_pos, camera_pos, camera_quat, camera_intrinsics, scalar_first=False):
    """
...
if __name__ == "__main__":
    ...
    # 计算 2D 坐标
    u, v = calculate_2d_position(gripper_pos, camera_pos, camera_quat, camera_intrinsics)
