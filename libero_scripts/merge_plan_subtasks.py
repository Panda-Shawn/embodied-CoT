...
if __name__ == "__main__":
    ...
    bboxes_file_path = os.path.join(args.data_dir, args.libero_task_suite, "cot", f"bboxes.json")
    with open(bboxes_file_path, "r") as f:
        bboxes = json.load(f)

    gripper_positions_file_path = os.path.join(args.data_dir, args.libero_task_suite, "cot", f"gripper_positions.json")
    with open(gripper_positions_file_path, "r") as f:
        gripper_positions = json.load(f)

    primitives_file_path = os.path.join(args.data_dir, args.libero_task_suite, "cot", f"{args.libero_task_suite}_primitives.json")
    ...
    reasonings_file_path = os.path.join(args.data_dir, args.libero_task_suite, "cot", "filtered_reasoning_h10.json")
    ...
    target_dir = os.path.join(args.data_dir, args.libero_task_suite, "cot")
